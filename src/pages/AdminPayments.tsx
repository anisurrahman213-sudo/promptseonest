...
import { useAdminPaymentRequests, useApprovePayment, useRejectPayment, useIsAdmin } from '@/hooks/usePaymentRequests';
      ...
      <main className="container py-8">
        <div className="flex items-center gap-3 mb-8">
          ...
          <div>
            ...
            <p className="text-muted-foreground">Manage payment requests</p>
          </div>
        </div>
        ...
        <Dialog open={!!selectedPayment && !!actionType} onOpenChange={() => { setSelectedPayment(null); setActionType(null); }}>
          <DialogContent>
            <DialogHeader>
              ...
              <DialogDescription>
                {actionType === 'approve' 
                  ? 'Enter the number of credits to add to the user account.'
            ...
            <DialogFooter>
              ...
              >
                ...
                {actionType === 'approve' ? 'Approve & Add Credits' : 'Reject'}
              </Button>
            </DialogFooter>
          </DialogContent>
        </Dialog>
